package com.soufiane.gestiondestock.utils;
...
public interface Constants {
    ...
    String FIND_COMMANDE_FOURNISSEUR_BY_CODE_ENDPOINT = COMMANDE_FOURNISSEUR_ENDPOINT + "/get/{codeCommandeFournisseur}";
    String FIND_ALL_COMMANDE_FOURNISSEUR = COMMANDE_FOURNISSEUR_ENDPOINT + "/all";
    String DELETE_COMMANDE_FOURNISSEUR_BY_ID = COMMANDE_FOURNISSEUR_ENDPOINT + "/delete/{idCommandeFournisseur}";
